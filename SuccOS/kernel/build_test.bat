...
.\..\..\Tools\VC152\CL.EXE /AT /G2 /Gs /Gx /c /Zl /I ".\..\libsrc\include" test\*.c	 .\..\libsrc\tests\*.c 

rem Compile all assembly files
.\..\..\Tools\VC152\ML.EXE /omf /c test\*.asm 

rem Link together all files and include the libary
.\..\..\Tools\VC152\LINK.EXE /T /NOD kernel.obj ktest.obj __string.obj, kernel.bin, nul, .\..\lib\libc.lib, nul
